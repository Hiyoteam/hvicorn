...
setup(
    ...
    description='Something for creating webapps like uvicorn, But for online chatrooms...', # 你的项目简介
    ...
    url='https://github.com/Hiyoteam/hvicorn', # 你的项目主页，一般为github仓库地址
    author='0x24a', # 你的姓名或者团队名称
    author_email='admin@thz.cool', # 你的邮箱或者团队邮箱
    license='MIT', # 你的项目使用的许可证，一般为MIT或者其他开源许可证
    classifiers=[ # 你的项目分类信息，可以从https://pypi.org/classifiers/中选择合适的分类
        ...
        'Programming Language :: Python :: 3.12', # 编程语言的具体版本，根据你的项目支持的python版本选择
    ],
    keywords='bot hack.chat hack.chat-bot', # 一些关键词，用于描述你的项目特点或者功能
    packages=find_packages('.', include=["hvicorn", "hvicorn.*"]), # 需要打包的python模块，一般使用find_packages函数自动查找，排除测试模块等不需要打包的模块
